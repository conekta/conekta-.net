namespace Conekta.net.Utils
{
    ...
    {
        public const string ConektaNetTargetFramework =
        #if NET8_0
                    "net8.0"
        #elif NET7_0
                    "net7.0"
        ...
        private static bool IsFullFramework => FrameworkDescription.StartsWith(".NET Framework", StringComparison.OrdinalIgnoreCase);
        ...
        {
            // the following code assumes that .NET netstandard2.0;net6.0;net8.0 is the oldest supported version
        ...
        private static bool TryGetCoreRuntimeVersion(out Version version)
        {
        ...
        private static bool TryGetVersionFromRuntimeDirectory(string runtimeDirectory, out Version version)
        {
        ...
        private static bool TryGetVersionFromProductInfo(string productVersion, string productName, out Version version)
        {
        ...
        private static bool TryGetVersionFromFrameworkName(string frameworkName, out Version version)
        {
