...
namespace Conekta.net.Model
{
    ...
    /// GetEventsResponse
    /// </summary>
    [DataContract(Name = "get_events_response")]
    public partial class GetEventsResponse : IEquatable<GetEventsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetEventsResponse(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<EventResponse> data = default(List<EventResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for GetEventsResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as GetEventsResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GetEventsResponse input)
        {
            if (input == null)
            {
                return false;
