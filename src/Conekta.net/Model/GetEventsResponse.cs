...
namespace Conekta.net.Model
{
    ...
    public partial class GetEventsResponse : IEquatable<GetEventsResponse>, IValidatableObject
    {
        ...
        public GetEventsResponse(bool hasMore = default(bool), string _object = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<EventResponse> data = default(List<EventResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for GetEventsResponse and cannot be null");
            }
            this.Object = _object;
