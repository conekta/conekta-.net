...
namespace Conekta.net.Model
{
    ...
    public partial class GetEventsResponse : IEquatable<GetEventsResponse>, IValidatableObject
    {
        ...
        public GetEventsResponse(string _object = default(string), bool hasMore = default(bool), string nextPageUrl = default(string), string previousPageUrl = default(string), List<EventResponse> data = default(List<EventResponse>))
        {
