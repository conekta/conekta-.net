...
namespace Conekta.net.Model
{
    ...
    public partial class CustomerPaymentMethodsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public CustomerPaymentMethodsResponse(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<CustomerPaymentMethodsData> data = default(List<CustomerPaymentMethodsData>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for CustomerPaymentMethodsResponse and cannot be null");
            }
