...
namespace Conekta.net.Model
{
    ...
    public partial class CustomerPaymentMethodsResponse : IEquatable<CustomerPaymentMethodsResponse>, IValidatableObject
    {
        ...
        public CustomerPaymentMethodsResponse(bool hasMore = default(bool), string _object = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<CustomerPaymentMethodsData> data = default(List<CustomerPaymentMethodsData>))
        {
