...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "order_response_shipping_lines")]
    public partial class OrderResponseShippingLines : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderResponseShippingLines" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderResponseShippingLines() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderResponseShippingLines" /> class.
        /// </summary>
        ...
        public OrderResponseShippingLines(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<ShippingLinesDataResponse> data = default(List<ShippingLinesDataResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for OrderResponseShippingLines and cannot be null");
            }
        ...
        */
        ...
        public List<ShippingLinesDataResponse> Data { get; set; }
