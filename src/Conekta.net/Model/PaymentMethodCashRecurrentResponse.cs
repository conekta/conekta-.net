...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "payment_method_cash_recurrent_response")]
    public partial class PaymentMethodCashRecurrentResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodCashRecurrentResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentMethodCashRecurrentResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodCashRecurrentResponse" /> class.
        /// </summary>
        ...
        public PaymentMethodCashRecurrentResponse(string type = default(string), string id = default(string), string varObject = default(string), long createdAt = default(long), string parentId = default(string), List<PaymentMethodCashResponseAllOfAgreements> agreements = default(List<PaymentMethodCashResponseAllOfAgreements>), string reference = default(string), string barcode = default(string), string barcodeUrl = default(string), long expiresAt = default(long), string provider = default(string))
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for PaymentMethodCashRecurrentResponse and cannot be null");
            }
            this.Type = type;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PaymentMethodCashRecurrentResponse and cannot be null");
            }
            this.Id = id;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for PaymentMethodCashRecurrentResponse and cannot be null");
            }
