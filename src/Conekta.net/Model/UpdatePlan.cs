...
namespace Conekta.net.Model
{
    ...
    /// a plan
    /// </summary>
    [DataContract(Name = "update_plan")]
    public partial class UpdatePlan : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePlan" /> class.
        /// </summary>
        ...
        public UpdatePlan(int amount = default(int), string currency = default(string), int expiryCount = default(int), string name = default(string))
        {
            this.Amount = amount;
