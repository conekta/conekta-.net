...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "order_channel_response")]
    public partial class OrderChannelResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderChannelResponse" /> class.
        /// </summary>
        /// <param name="segment">segment.</param>
        /// <param name="checkoutRequestId">checkoutRequestId.</param>
        /// <param name="checkoutRequestType">checkoutRequestType.</param>
        /// <param name="id">id.</param>
        public OrderChannelResponse(string segment = default(string), string checkoutRequestId = default(string), string checkoutRequestType = default(string), string id = default(string))
        {
