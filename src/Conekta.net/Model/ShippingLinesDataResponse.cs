...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "shipping_lines_data_response")]
    public partial class ShippingLinesDataResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShippingLinesDataResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShippingLinesDataResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShippingLinesDataResponse" /> class.
        /// </summary>
        ...
        public ShippingLinesDataResponse(long amount = default(long), string carrier = default(string), string trackingNumber = default(string), string method = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), string id = default(string), string varObject = default(string), string parentId = default(string))
        {
            this.Amount = amount;
