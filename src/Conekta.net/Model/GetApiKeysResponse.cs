...
namespace Conekta.net.Model
{
    ...
    public partial class GetApiKeysResponse : IEquatable<GetApiKeysResponse>, IValidatableObject
    {
        ...
        public GetApiKeysResponse(string nextPageUrl = default(string), string previousPageUrl = default(string), bool hasMore = default(bool), string _object = default(string), List<ApiKeyResponse> data = default(List<ApiKeyResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for GetApiKeysResponse and cannot be null");
            }
            this.Object = _object;
