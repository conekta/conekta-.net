...
namespace Conekta.net.Model
{
    ...
    public partial class GetApiKeysResponse : IEquatable<GetApiKeysResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetApiKeysResponse(string nextPageUrl = default(string), string previousPageUrl = default(string), bool hasMore = default(bool), string varObject = default(string), List<ApiKeyResponse> data = default(List<ApiKeyResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for GetApiKeysResponse and cannot be null");
            }
