...
namespace Conekta.net.Model
{
    ...
    public partial class PaymentMethodCashRequest : IEquatable<PaymentMethodCashRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaymentMethodCashRequest);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(PaymentMethodCashRequest input)
        {
            if (input == null)
            {
                return false;
