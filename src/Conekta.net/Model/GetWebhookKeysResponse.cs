...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "get_webhook_keys_response")]
    public partial class GetWebhookKeysResponse : IEquatable<GetWebhookKeysResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWebhookKeysResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWebhookKeysResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWebhookKeysResponse" /> class.
        /// </summary>
        ...
        public GetWebhookKeysResponse(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<WebhookKeyResponse> data = default(List<WebhookKeyResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for GetWebhookKeysResponse and cannot be null");
            }
        ...
        public List<WebhookKeyResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as GetWebhookKeysResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GetWebhookKeysResponse input)
        {
            if (input == null)
            {
                return false;
