...
namespace Conekta.net.Model
{
    ...
    public partial class GetWebhookKeysResponse : IEquatable<GetWebhookKeysResponse>, IValidatableObject
    {
        ...
        public GetWebhookKeysResponse(string _object = default(string), bool hasMore = default(bool), string nextPageUrl = default(string), string previousPageUrl = default(string), List<WebhookKeyResponse> data = default(List<WebhookKeyResponse>))
        {
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for GetWebhookKeysResponse and cannot be null");
            }
            this.Object = _object;
