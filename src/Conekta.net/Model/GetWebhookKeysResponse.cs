...
namespace Conekta.net.Model
{
    ...
    public partial class GetWebhookKeysResponse : IEquatable<GetWebhookKeysResponse>, IValidatableObject
    {
        ...
        public GetWebhookKeysResponse(bool hasMore = default(bool), string _object = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<WebhookKeyResponse> data = default(List<WebhookKeyResponse>))
        {
