...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "customer_update_shipping_contacts_request")]
    public partial class CustomerUpdateShippingContactsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerUpdateShippingContactsRequest" /> class.
        /// </summary>
        ...
        public CustomerUpdateShippingContactsRequest(string phone = default(string), string receiver = default(string), string betweenStreets = default(string), CustomerShippingContactsRequestAddress address = default(CustomerShippingContactsRequestAddress), string parentId = default(string), bool varDefault = default(bool), bool deleted = default(bool))
        {
            this.Phone = phone;
