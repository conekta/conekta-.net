...
namespace Conekta.net.Model
{
    ...
    public partial class OrderResponseDiscountLines : IEquatable<OrderResponseDiscountLines>, IValidatableObject
    {
        ...
        public OrderResponseDiscountLines(bool hasMore = default(bool), string _object = default(string), List<DiscountLinesDataResponse> data = default(List<DiscountLinesDataResponse>))
        {
