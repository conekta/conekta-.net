...
namespace Conekta.net.Model
{
    ...
    public partial class OrderResponseDiscountLines : IValidatableObject
    {
        /// <summary>
        ...
        public OrderResponseDiscountLines(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<DiscountLinesDataResponse> data = default(List<DiscountLinesDataResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for OrderResponseDiscountLines and cannot be null");
            }
