...
namespace Conekta.net.Model
{
    ...
    public partial class CustomerAntifraudInfoResponse : IEquatable<CustomerAntifraudInfoResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CustomerAntifraudInfoResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CustomerAntifraudInfoResponse input)
        {
            if (input == null)
            {
                return false;
