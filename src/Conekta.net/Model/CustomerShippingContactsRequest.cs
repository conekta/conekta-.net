...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "customer_shipping_contacts_request")]
    public partial class CustomerShippingContactsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerShippingContactsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomerShippingContactsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerShippingContactsRequest" /> class.
        /// </summary>
        ...
        public CustomerShippingContactsRequest(string phone = default(string), string receiver = default(string), string betweenStreets = default(string), CustomerShippingContactsRequestAddress address = default(CustomerShippingContactsRequestAddress), string parentId = default(string), bool varDefault = default(bool), bool deleted = default(bool), Dictionary<string, Object> metadata = default(Dictionary<string, Object>))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for CustomerShippingContactsRequest and cannot be null");
            }
