...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "get_order_discount_lines_response")]
    public partial class GetOrderDiscountLinesResponse : IEquatable<GetOrderDiscountLinesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrderDiscountLinesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetOrderDiscountLinesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrderDiscountLinesResponse" /> class.
        /// </summary>
        ...
        public GetOrderDiscountLinesResponse(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<DiscountLinesResponse> data = default(List<DiscountLinesResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for GetOrderDiscountLinesResponse and cannot be null");
            }
        ...
        public List<DiscountLinesResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as GetOrderDiscountLinesResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GetOrderDiscountLinesResponse input)
        {
            if (input == null)
            {
                return false;
