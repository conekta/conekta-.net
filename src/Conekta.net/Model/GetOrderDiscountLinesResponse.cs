...
namespace Conekta.net.Model
{
    ...
    public partial class GetOrderDiscountLinesResponse : IEquatable<GetOrderDiscountLinesResponse>, IValidatableObject
    {
        ...
        public GetOrderDiscountLinesResponse(bool hasMore = default(bool), string _object = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<DiscountLinesResponse> data = default(List<DiscountLinesResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for GetOrderDiscountLinesResponse and cannot be null");
            }
            this.Object = _object;
