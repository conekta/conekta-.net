...
namespace Conekta.net.Model
{
    ...
    public partial class ChargesOrderResponseAllOfData : IValidatableObject
    {
        ...
        protected ChargesOrderResponseAllOfData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargesOrderResponseAllOfData" /> class.
        /// </summary>
        ...
        public ChargesOrderResponseAllOfData(int amount = default(int), ChargeResponseChannel channel = default(ChargeResponseChannel), long createdAt = default(long), string currency = default(string), string customerId = default(string), string description = default(string), string deviceFingerprint = default(string), string failureCode = default(string), string failureMessage = default(string), string id = default(string), bool livemode = default(bool), string varObject = default(string), string orderId = default(string), long? paidAt = default(long?), ChargeResponsePaymentMethod paymentMethod = default(ChargeResponsePaymentMethod), string referenceId = default(string), ChargeResponseRefunds refunds = default(ChargeResponseRefunds), string status = default(string))
        {
            ...
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for ChargesOrderResponseAllOfData and cannot be null");
            }
            this.Currency = currency;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ChargesOrderResponseAllOfData and cannot be null");
            }
            this.Id = id;
            ...
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for ChargesOrderResponseAllOfData and cannot be null");
            }
            this.Object = varObject;
            // to ensure "orderId" is required (not null)
            if (orderId == null)
            {
                throw new ArgumentNullException("orderId is a required property for ChargesOrderResponseAllOfData and cannot be null");
            }
            this.OrderId = orderId;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for ChargesOrderResponseAllOfData and cannot be null");
            }
            this.Status = status;
