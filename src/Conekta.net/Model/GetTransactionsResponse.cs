...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "get_transactions_response")]
    public partial class GetTransactionsResponse : IEquatable<GetTransactionsResponse>, IValidatableObject
    {
        ...
        public GetTransactionsResponse(string _object = default(string), bool hasMore = default(bool), string nextPageUrl = default(string), string previousPageUrl = default(string), List<TransactionResponse> data = default(List<TransactionResponse>))
        {
