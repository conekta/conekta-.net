...
namespace Conekta.net.Model
{
    ...
    /// PaymentSourceCard
    /// </summary>
    [DataContract(Name = "payment_source_card")]
    public partial class PaymentSourceCard : IEquatable<PaymentSourceCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentSourceCard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentSourceCard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentSourceCard" /> class.
        /// </summary>
        ...
        public PaymentSourceCard(string type = default(string), string id = default(string), string _object = default(string), long createdAt = default(long), string parentId = default(string), string last4 = default(string), string bin = default(string), string cardType = default(string), string expMonth = default(string), string expYear = default(string), string brand = default(string), string name = default(string), bool _default = default(bool), bool visibleOnCheckout = default(bool), string paymentSourceStatus = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for PaymentSourceCard and cannot be null");
            }
            this.Type = type;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PaymentSourceCard and cannot be null");
            }
            this.Id = id;
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for PaymentSourceCard and cannot be null");
            }
            this.Object = _object;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentSourceCard {\n");
        ...
        {
            return this.Equals(input as PaymentSourceCard);
        }

        /// <summary>
        /// Returns true if PaymentSourceCard instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentSourceCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentSourceCard input)
        {
            if (input == null)
            {
                return false;
