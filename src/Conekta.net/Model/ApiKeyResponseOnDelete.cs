...
namespace Conekta.net.Model
{
    ...
    public partial class ApiKeyResponseOnDelete : IValidatableObject
    {
        ...
        public ApiKeyResponseOnDelete(bool active = default(bool), long createdAt = default(long), string description = default(string), bool livemode = default(bool), string prefix = default(string), string id = default(string), string varObject = default(string), long? lastUsedAt = default(long?), string role = default(string))
        {
            this.Active = active;
