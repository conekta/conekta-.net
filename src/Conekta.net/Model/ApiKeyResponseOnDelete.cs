...
namespace Conekta.net.Model
{
    ...
    public partial class ApiKeyResponseOnDelete : IEquatable<ApiKeyResponseOnDelete>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ApiKeyResponseOnDelete);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ApiKeyResponseOnDelete input)
        {
            if (input == null)
            {
                return false;
