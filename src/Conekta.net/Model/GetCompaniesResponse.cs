...
namespace Conekta.net.Model
{
    ...
    public partial class GetCompaniesResponse : IEquatable<GetCompaniesResponse>, IValidatableObject
    {
        ...
        public GetCompaniesResponse(bool hasMore = default(bool), string _object = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<CompanyResponse> data = default(List<CompanyResponse>))
        {
