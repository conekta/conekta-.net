...
namespace Conekta.net.Model
{
    ...
    public partial class GetCompaniesResponse : IEquatable<GetCompaniesResponse>, IValidatableObject
    {
        ...
        public GetCompaniesResponse(string _object = default(string), bool hasMore = default(bool), string nextPageUrl = default(string), string previousPageUrl = default(string), List<CompanyResponse> data = default(List<CompanyResponse>))
        {
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for GetCompaniesResponse and cannot be null");
            }
            this.Object = _object;
