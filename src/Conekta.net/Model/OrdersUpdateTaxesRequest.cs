...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ordersUpdateTaxes_request")]
    public partial class OrdersUpdateTaxesRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrdersUpdateTaxesRequest" /> class.
        /// </summary>
        ...
        public OrdersUpdateTaxesRequest(long amount = default(long), string description = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>))
        {
            this.Amount = amount;
