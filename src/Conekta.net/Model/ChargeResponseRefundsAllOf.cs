...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "charge_response_refunds_allOf")]
    public partial class ChargeResponseRefundsAllOf : IEquatable<ChargeResponseRefundsAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ChargeResponseRefundsAllOf);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ChargeResponseRefundsAllOf input)
        {
            if (input == null)
            {
                return false;
