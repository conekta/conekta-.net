...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "order_response_tax_lines")]
    public partial class OrderResponseTaxLines : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderResponseTaxLines" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderResponseTaxLines() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderResponseTaxLines" /> class.
        /// </summary>
        ...
        public OrderResponseTaxLines(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<TaxLinesDataResponse> data = default(List<TaxLinesDataResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for OrderResponseTaxLines and cannot be null");
            }
