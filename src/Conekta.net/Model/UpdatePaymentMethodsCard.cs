...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "update_payment_methods_card")]
    public partial class UpdatePaymentMethodsCard : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePaymentMethodsCard" /> class.
        /// </summary>
        ...
        public UpdatePaymentMethodsCard(string name = default(string), long expiresAt = default(long))
        {
            this.Name = name;
