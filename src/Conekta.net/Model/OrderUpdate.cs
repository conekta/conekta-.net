...
namespace Conekta.net.Model
{
    ...
    /// a order
    /// </summary>
    [DataContract(Name = "order_update")]
    public partial class OrderUpdate : IValidatableObject
    {
        ...
        /// <param name="discountLines">List of [discounts](https://developers.conekta.com/v2.3.0/reference/orderscreatediscountline) that are applied to the order..</param>
        /// <param name="fiscalEntity">fiscalEntity.</param>
        /// <param name="lineItems">List of [products](https://developers.conekta.com/v2.3.0/reference/orderscreateproduct) that are sold in the order. You must have at least one product..</param>
        ...
        /// <param name="shippingLines">List of [shipping costs](https://developers.conekta.com/v2.3.0/reference/orderscreateshipping). If the online store offers digital products..</param>
        /// <param name="taxLines">taxLines.</param>
        public OrderUpdate(List<ChargeRequest> charges = default(List<ChargeRequest>), OrderCheckoutRequest checkout = default(OrderCheckoutRequest), string currency = default(string), OrderUpdateCustomerInfo customerInfo = default(OrderUpdateCustomerInfo), List<OrderDiscountLinesRequest> discountLines = default(List<OrderDiscountLinesRequest>), OrderUpdateFiscalEntityRequest fiscalEntity = default(OrderUpdateFiscalEntityRequest), List<Product> lineItems = default(List<Product>), Dictionary<string, string> metadata = default(Dictionary<string, string>), bool preAuthorize = default(bool), CustomerShippingContactsRequest shippingContact = default(CustomerShippingContactsRequest), List<ShippingRequest> shippingLines = default(List<ShippingRequest>), List<OrderTaxRequest> taxLines = default(List<OrderTaxRequest>))
        {
        ...
        */
        ...
        public OrderUpdateCustomerInfo CustomerInfo { get; set; }

        /// <summary>
        /// List of [discounts](https://developers.conekta.com/v2.3.0/reference/orderscreatediscountline) that are applied to the order.
        /// </summary>
        /// <value>List of [discounts](https://developers.conekta.com/v2.3.0/reference/orderscreatediscountline) that are applied to the order.</value>
        ...
        /// </summary>
        /// <value>List of [products](https://developers.conekta.com/v2.3.0/reference/orderscreateproduct) that are sold in the order. You must have at least one product.</value>
        ...
        /// </summary>
        /// <value>List of [shipping costs](https://developers.conekta.com/v2.3.0/reference/orderscreateshipping). If the online store offers digital products.</value>
