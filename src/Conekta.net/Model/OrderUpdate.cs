...
namespace Conekta.net.Model
{
    ...
    public partial class OrderUpdate : IValidatableObject
    {
        ...
        /// <param name="lineItems">List of [products](https://developers.conekta.com/v2.2.0/reference/orderscreateproduct) that are sold in the order. You must have at least one product..</param>
        ...
        */
        ...
        /// </summary>
        /// <value>List of [products](https://developers.conekta.com/v2.2.0/reference/orderscreateproduct) that are sold in the order. You must have at least one product.</value>
        ...
        /// </summary>
        /// <value>List of [shipping costs](https://developers.conekta.com/v2.2.0/reference/orderscreateshipping). If the online store offers digital products.</value>
