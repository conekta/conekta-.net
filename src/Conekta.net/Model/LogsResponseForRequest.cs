...
namespace Conekta.net.Model
{
    ...
    /// logs model
    /// </summary>
    [DataContract(Name = "logs_response_for_request")]
    public partial class LogsResponseForRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogsResponseForRequest" /> class.
        /// </summary>
        ...
        public LogsResponseForRequest(string nextPageUrl = default(string), string previousPageUrl = default(string), List<LogsResponseData> data = default(List<LogsResponseData>))
        {
