...
namespace Conekta.net.Model
{
    ...
    public partial class UpdatePaymentMethods : IEquatable<UpdatePaymentMethods>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdatePaymentMethods);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePaymentMethods input)
        {
            if (input == null)
            {
                return false;
