...
namespace Conekta.net.Model
{
    ...
    public partial class GetPlansResponse : IEquatable<GetPlansResponse>, IValidatableObject
    {
        ...
        public GetPlansResponse(string _object = default(string), bool hasMore = default(bool), string nextPageUrl = default(string), string previousPageUrl = default(string), List<PlanResponse> data = default(List<PlanResponse>))
        {
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for GetPlansResponse and cannot be null");
            }
            this.Object = _object;
