...
namespace Conekta.net.Model
{
    ...
    /// GetPlansResponse
    /// </summary>
    [DataContract(Name = "get_plans_response")]
    public partial class GetPlansResponse : IEquatable<GetPlansResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPlansResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPlansResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPlansResponse" /> class.
        /// </summary>
        ...
        public GetPlansResponse(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<PlanResponse> data = default(List<PlanResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for GetPlansResponse and cannot be null");
            }
        ...
        public List<PlanResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as GetPlansResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GetPlansResponse input)
        {
            if (input == null)
            {
                return false;
