...
namespace Conekta.net.Model
{
    ...
    public partial class GetPlansResponse : IEquatable<GetPlansResponse>, IValidatableObject
    {
        ...
        public GetPlansResponse(bool hasMore = default(bool), string _object = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<PlanResponse> data = default(List<PlanResponse>))
        {
