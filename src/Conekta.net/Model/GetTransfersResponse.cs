...
namespace Conekta.net.Model
{
    ...
    public partial class GetTransfersResponse : IEquatable<GetTransfersResponse>, IValidatableObject
    {
        ...
        public GetTransfersResponse(string _object = default(string), bool hasMore = default(bool), string nextPageUrl = default(string), string previousPageUrl = default(string), List<TransfersResponse> data = default(List<TransfersResponse>))
        {
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for GetTransfersResponse and cannot be null");
            }
            this.Object = _object;
