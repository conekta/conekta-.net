...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "get_transfers_response")]
    public partial class GetTransfersResponse : IEquatable<GetTransfersResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransfersResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetTransfersResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTransfersResponse" /> class.
        /// </summary>
        ...
        public GetTransfersResponse(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<TransfersResponse> data = default(List<TransfersResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for GetTransfersResponse and cannot be null");
            }
        ...
        public List<TransfersResponse> Data { get; set; }
        ...
        {
            return this.Equals(input as GetTransfersResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GetTransfersResponse input)
        {
            if (input == null)
            {
                return false;
