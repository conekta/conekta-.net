...
namespace Conekta.net.Model
{
    ...
    public partial class GetTransfersResponse : IEquatable<GetTransfersResponse>, IValidatableObject
    {
        ...
        public GetTransfersResponse(bool hasMore = default(bool), string _object = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<TransfersResponse> data = default(List<TransfersResponse>))
        {
