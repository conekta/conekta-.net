...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "order_tax_response")]
    public partial class OrderTaxResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderTaxResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderTaxResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderTaxResponse" /> class.
        /// </summary>
        ...
        public OrderTaxResponse(long amount = default(long), string description = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), string id = default(string), string varObject = default(string), string parentId = default(string))
        {
            this.Amount = amount;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for OrderTaxResponse and cannot be null");
            }
            this.Description = description;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for OrderTaxResponse and cannot be null");
            }
            this.Id = id;
