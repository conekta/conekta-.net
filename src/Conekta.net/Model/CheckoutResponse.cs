...
namespace Conekta.net.Model
{
    ...
    public partial class CheckoutResponse : IValidatableObject
    {
        ...
        /// <param name="excludedPaymentMethods">Payment methods excluded from the checkout. This field is only returned when excluded_payment_methods is provided in the request..</param>
        ...
        */
        ...
        /// </summary>
        /// <value>Payment methods excluded from the checkout. This field is only returned when excluded_payment_methods is provided in the request.</value>
        /*
        <example>[cash, bank_transfer]</example>
        */
        [DataMember(Name = "excluded_payment_methods", EmitDefaultValue = false)]
        public List<CheckoutResponse.ExcludedPaymentMethodsEnum> ExcludedPaymentMethods { get; set; }
