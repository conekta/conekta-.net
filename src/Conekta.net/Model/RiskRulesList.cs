...
namespace Conekta.net.Model
{
    ...
    public partial class RiskRulesList : IValidatableObject
    {
        /// <summary>
        ...
        public RiskRulesList(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<RiskRulesData> data = default(List<RiskRulesData>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for RiskRulesList and cannot be null");
            }
