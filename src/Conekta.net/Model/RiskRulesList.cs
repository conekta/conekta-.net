...
namespace Conekta.net.Model
{
    ...
    public partial class RiskRulesList : IEquatable<RiskRulesList>, IValidatableObject
    {
        ...
        public RiskRulesList(bool hasMore = default(bool), string _object = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<RiskRulesData> data = default(List<RiskRulesData>))
        {
