...
namespace Conekta.net.Model
{
    ...
    public partial class CustomerPaymentSourcesResponse : IEquatable<CustomerPaymentSourcesResponse>, IValidatableObject
    {
        ...
        public CustomerPaymentSourcesResponse(string _object = default(string), bool hasMore = default(bool), List<CustomerPaymentSourcesData> data = default(List<CustomerPaymentSourcesData>))
        {
