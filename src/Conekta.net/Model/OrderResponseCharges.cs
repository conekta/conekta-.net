...
namespace Conekta.net.Model
{
    ...
    public partial class OrderResponseCharges : IEquatable<OrderResponseCharges>, IValidatableObject
    {
        ...
        public OrderResponseCharges(bool hasMore = default(bool), string _object = default(string), List<ChargesDataResponse> data = default(List<ChargesDataResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for OrderResponseCharges and cannot be null");
            }
            this.Object = _object;
            this.Data = data;
        }
