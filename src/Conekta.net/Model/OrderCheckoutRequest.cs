...
namespace Conekta.net.Model
{
    ...
    public partial class OrderCheckoutRequest : IValidatableObject
    {
        ...
        public OrderCheckoutRequest(List<AllowedPaymentMethodsEnum> allowedPaymentMethods = default(List<AllowedPaymentMethodsEnum>), List<ExcludeCardNetworksEnum> excludeCardNetworks = default(List<ExcludeCardNetworksEnum>), List<string> planIds = default(List<string>), long expiresAt = default(long), string failureUrl = default(string), bool forceSaveCard = default(bool), bool monthlyInstallmentsEnabled = default(bool), List<int> monthlyInstallmentsOptions = default(List<int>), int maxFailedRetries = default(int), string name = default(string), bool onDemandEnabled = default(bool), int redirectionTime = default(int), string successUrl = default(string), TypeEnum? type = default(TypeEnum?))
        {
        ...
        /*
        <example>[cash, card, bank_transfer, bnpl, pay_by_bank, google, apple]</example>
        */
