...
namespace Conekta.net.Model
{
    ...
    public partial class Payout : IValidatableObject
    {
        ...
        public Payout(PayoutMethod payoutMethod = default(PayoutMethod))
        {
            // to ensure "payoutMethod" is required (not null)
            if (payoutMethod == null)
            {
                throw new ArgumentNullException("payoutMethod is a required property for Payout and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "payout_method", IsRequired = true, EmitDefaultValue = true)]
