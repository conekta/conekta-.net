...
namespace Conekta.net.Model
{
    ...
    public partial class Checkout : IValidatableObject
    {
        ...
        /// <param name="expiresAt">It is the time when the link will expire.  It is expressed in seconds since the Unix epoch. The valid range is from 10 minutes to 365 days from the creation date.  (required).</param>
        ...
        */
        ...
        /// </summary>
        /// <value>It is the time when the link will expire.  It is expressed in seconds since the Unix epoch. The valid range is from 10 minutes to 365 days from the creation date. </value>
        /*
