...
namespace Conekta.net.Model
{
    ...
    /// WebhookKeyRequest
    /// </summary>
    [DataContract(Name = "webhook_key_request")]
    public partial class WebhookKeyRequest : IEquatable<WebhookKeyRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as WebhookKeyRequest);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(WebhookKeyRequest input)
        {
            if (input == null)
            {
                return false;
