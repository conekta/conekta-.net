...
namespace Conekta.net.Model
{
    ...
    public partial class PayoutOrderRequest : IValidatableObject
    {
        ...
        public PayoutOrderRequest(List<string> allowedPayoutMethods = default(List<string>), long amount = default(long), string currency = @"MXN", PayoutOrderRequestCustomerInfo customerInfo = default(PayoutOrderRequestCustomerInfo), long expiresAt = default(long), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), Payout payout = default(Payout), string reason = default(string))
        {
        ...
        */
        ...
        public PayoutOrderRequestCustomerInfo CustomerInfo { get; set; }
