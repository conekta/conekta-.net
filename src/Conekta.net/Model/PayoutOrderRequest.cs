...
namespace Conekta.net.Model
{
    ...
    /// a payout order
    /// </summary>
    [DataContract(Name = "payout_order_request")]
    public partial class PayoutOrderRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayoutOrderRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayoutOrderRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayoutOrderRequest" /> class.
        /// </summary>
        ...
        /// <param name="customerInfo">The customer information to whom the payout order is made. (required).</param>
        /// <param name="expiresAt">The expiration time of the payout order in Unix timestamp. (required).</param>
        ...
        public PayoutOrderRequest(List<string> allowedPayoutMethods = default(List<string>), long amount = default(long), string currency = @"MXN", Object customerInfo = default(Object), long expiresAt = default(long), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), Payout payout = default(Payout), string reason = default(string))
        {
            // to ensure "allowedPayoutMethods" is required (not null)
            if (allowedPayoutMethods == null)
            {
                throw new ArgumentNullException("allowedPayoutMethods is a required property for PayoutOrderRequest and cannot be null");
            }
            ...
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for PayoutOrderRequest and cannot be null");
            }
            this.Currency = currency;
            // to ensure "customerInfo" is required (not null)
            if (customerInfo == null)
            {
                throw new ArgumentNullException("customerInfo is a required property for PayoutOrderRequest and cannot be null");
            }
            ...
            if (payout == null)
            {
                throw new ArgumentNullException("payout is a required property for PayoutOrderRequest and cannot be null");
            }
            this.Payout = payout;
            // to ensure "reason" is required (not null)
            if (reason == null)
            {
                throw new ArgumentNullException("reason is a required property for PayoutOrderRequest and cannot be null");
            }
            this.Reason = reason;
        ...
        */
        ...
        /// </summary>
        /// <value>The customer information to whom the payout order is made.</value>
        ...
        /// </summary>
        /// <value>The expiration time of the payout order in Unix timestamp.</value>
        /*
