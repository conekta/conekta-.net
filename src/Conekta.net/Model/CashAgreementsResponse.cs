...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "cash_agreements_response")]
    public partial class CashAgreementsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CashAgreementsResponse" /> class.
        /// </summary>
        ...
        public CashAgreementsResponse(string agreement = default(string), string provider = default(string))
        {
