...
namespace Conekta.net.Model
{
    ...
    public partial class CreateCustomerPaymentMethodsResponse : AbstractOpenAPISchema, IEquatable<CreateCustomerPaymentMethodsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateCustomerPaymentMethodsResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CreateCustomerPaymentMethodsResponse input)
        {
            if (input == null)
                return false;
