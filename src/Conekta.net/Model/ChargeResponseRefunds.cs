...
namespace Conekta.net.Model
{
    ...
    public partial class ChargeResponseRefunds : IEquatable<ChargeResponseRefunds>, IValidatableObject
    {
        ...
        public ChargeResponseRefunds(string _object = default(string), bool hasMore = default(bool), string nextPageUrl = default(string), string previousPageUrl = default(string), List<ChargeResponseRefundsData> data = default(List<ChargeResponseRefundsData>))
        {
