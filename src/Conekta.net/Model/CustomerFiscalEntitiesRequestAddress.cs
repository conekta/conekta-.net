...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "customer_fiscal_entities_request_address")]
    public partial class CustomerFiscalEntitiesRequestAddress : IEquatable<CustomerFiscalEntitiesRequestAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerFiscalEntitiesRequestAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomerFiscalEntitiesRequestAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerFiscalEntitiesRequestAddress" /> class.
        /// </summary>
        ...
        public CustomerFiscalEntitiesRequestAddress(string street1 = default(string), string street2 = default(string), string postalCode = default(string), string city = default(string), string state = default(string), string country = default(string), bool residential = false, string externalNumber = default(string))
        {
            ...
            if (street1 == null)
            {
                throw new ArgumentNullException("street1 is a required property for CustomerFiscalEntitiesRequestAddress and cannot be null");
            }
            this.Street1 = street1;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for CustomerFiscalEntitiesRequestAddress and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for CustomerFiscalEntitiesRequestAddress and cannot be null");
            }
            this.City = city;
        ...
        {
            return this.Equals(input as CustomerFiscalEntitiesRequestAddress);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(CustomerFiscalEntitiesRequestAddress input)
        {
            if (input == null)
            {
                return false;
