...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "order_shipping_lines_response")]
    public partial class OrderShippingLinesResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderShippingLinesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderShippingLinesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderShippingLinesResponse" /> class.
        /// </summary>
        ...
        public OrderShippingLinesResponse(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<ShippingLinesDataResponse> data = default(List<ShippingLinesDataResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for OrderShippingLinesResponse and cannot be null");
            }
