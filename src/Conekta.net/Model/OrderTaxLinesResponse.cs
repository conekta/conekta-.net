...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "order_tax_lines_response")]
    public partial class OrderTaxLinesResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderTaxLinesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderTaxLinesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderTaxLinesResponse" /> class.
        /// </summary>
        ...
        public OrderTaxLinesResponse(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<TaxLinesDataResponse> data = default(List<TaxLinesDataResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for OrderTaxLinesResponse and cannot be null");
            }
        ...
        */
        ...
        public List<TaxLinesDataResponse> Data { get; set; }
