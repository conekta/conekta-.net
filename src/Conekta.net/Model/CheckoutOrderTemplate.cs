...
namespace Conekta.net.Model
{
    ...
    public partial class CheckoutOrderTemplate : IValidatableObject
    {
        ...
        public CheckoutOrderTemplate(string currency = default(string), OrderRequestCustomerInfo customerInfo = default(OrderRequestCustomerInfo), List<Product> lineItems = default(List<Product>), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), List<OrderTaxRequest> taxLines = default(List<OrderTaxRequest>), List<OrderDiscountLinesRequest> discountLines = default(List<OrderDiscountLinesRequest>))
        {
