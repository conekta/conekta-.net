...
{
    /// <summary>
    /// CustomersShippingContactsDataResponse
    /// </summary>
    [DataContract(Name = "customers_shipping_contacts_data_response")]
    public partial class CustomersShippingContactsDataResponse : IEquatable<CustomersShippingContactsDataResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomersShippingContactsDataResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomersShippingContactsDataResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomersShippingContactsDataResponse" /> class.
        /// </summary>
        ...
        public CustomersShippingContactsDataResponse(string phone = default(string), string receiver = default(string), string betweenStreets = default(string), CustomerShippingContactsAddress address = default(CustomerShippingContactsAddress), string parentId = default(string), bool? _default = default(bool?), bool? deleted = default(bool?), string id = default(string), string _object = default(string), long createdAt = default(long))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CustomersShippingContactsDataResponse and cannot be null");
            }
            this.Id = id;
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for CustomersShippingContactsDataResponse and cannot be null");
            }
            this.Object = _object;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomersShippingContactsDataResponse {\n");
        ...
        {
            return this.Equals(input as CustomersShippingContactsDataResponse);
        }

        /// <summary>
        /// Returns true if CustomersShippingContactsDataResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomersShippingContactsDataResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomersShippingContactsDataResponse input)
        {
            if (input == null)
            {
                return false;
