...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "payment_method_card_response_allOf")]
    public partial class PaymentMethodCardResponseAllOf : IEquatable<PaymentMethodCardResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentMethodCardResponseAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PaymentMethodCardResponseAllOf);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(PaymentMethodCardResponseAllOf input)
        {
            if (input == null)
            {
                return false;
