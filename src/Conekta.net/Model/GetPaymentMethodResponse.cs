...
namespace Conekta.net.Model
{
    ...
    public partial class GetPaymentMethodResponse : IEquatable<GetPaymentMethodResponse>, IValidatableObject
    {
        ...
        public GetPaymentMethodResponse(string _object = default(string), bool hasMore = default(bool), string nextPageUrl = default(string), string previousPageUrl = default(string), List<GetCustomerPaymentMethodDataResponse> data = default(List<GetCustomerPaymentMethodDataResponse>))
        {
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for GetPaymentMethodResponse and cannot be null");
            }
            this.Object = _object;
