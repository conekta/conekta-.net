...
namespace Conekta.net.Model
{
    ...
    public partial class GetPaymentMethodResponse : IEquatable<GetPaymentMethodResponse>, IValidatableObject
    {
        ...
        public GetPaymentMethodResponse(bool hasMore = default(bool), string _object = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<GetCustomerPaymentMethodDataResponse> data = default(List<GetCustomerPaymentMethodDataResponse>))
        {
