...
namespace Conekta.net.Model
{
    ...
    public partial class GetPaymentMethodResponse : IValidatableObject
    {
        ...
        protected GetPaymentMethodResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPaymentMethodResponse" /> class.
        /// </summary>
        ...
        public GetPaymentMethodResponse(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<GetCustomerPaymentMethodDataResponse> data = default(List<GetCustomerPaymentMethodDataResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for GetPaymentMethodResponse and cannot be null");
            }
