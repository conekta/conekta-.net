...
namespace Conekta.net.Model
{
    ...
    public partial class GetWebhooksResponse : IValidatableObject
    {
        /// <summary>
        ...
        public GetWebhooksResponse(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<WebhookResponse> data = default(List<WebhookResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for GetWebhooksResponse and cannot be null");
            }
