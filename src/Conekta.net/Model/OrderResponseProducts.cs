...
namespace Conekta.net.Model
{
    ...
    public partial class OrderResponseProducts : IEquatable<OrderResponseProducts>, IValidatableObject
    {
        ...
        public OrderResponseProducts(bool hasMore = default(bool), string _object = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<ProductDataResponse> data = default(List<ProductDataResponse>))
        {
