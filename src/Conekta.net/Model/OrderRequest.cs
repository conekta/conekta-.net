...
namespace Conekta.net.Model
{
    ...
    public partial class OrderRequest : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="OrderRequest" /> class.
        /// </summary>
        /// <param name="charges">List of [charges](https://developers.conekta.com/v2.3.0/reference/orderscreatecharge) that are applied to the order.</param>
        ...
        /// <param name="lineItems">List of [products](https://developers.conekta.com/v2.3.0/reference/orderscreateproduct) that are sold in the order. You must have at least one product. (required).</param>
        ...
        /// <param name="taxLines">List of [taxes](https://developers.conekta.com/v2.3.0/reference/orderscreatetaxes) that are applied to the order..</param>
        ...
        /// </summary>
        /// <value>List of [charges](https://developers.conekta.com/v2.3.0/reference/orderscreatecharge) that are applied to the order</value>
        ...
        */
        ...
        /// </summary>
        /// <value>List of [taxes](https://developers.conekta.com/v2.3.0/reference/orderscreatetaxes) that are applied to the order.</value>
