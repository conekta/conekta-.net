...
namespace Conekta.net.Model
{
    ...
    public partial class CustomerResponseShippingContacts : IEquatable<CustomerResponseShippingContacts>, IValidatableObject
    {
        ...
        public CustomerResponseShippingContacts(bool hasMore = default(bool), string _object = default(string), List<CustomerShippingContactsDataResponse> data = default(List<CustomerShippingContactsDataResponse>))
        {
