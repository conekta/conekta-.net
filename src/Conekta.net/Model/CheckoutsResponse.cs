...
namespace Conekta.net.Model
{
    ...
    public partial class CheckoutsResponse : IEquatable<CheckoutsResponse>, IValidatableObject
    {
        ...
        public CheckoutsResponse(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<CheckoutResponse> data = default(List<CheckoutResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for CheckoutsResponse and cannot be null");
            }
