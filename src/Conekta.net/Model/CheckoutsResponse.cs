...
namespace Conekta.net.Model
{
    ...
    public partial class CheckoutsResponse : IEquatable<CheckoutsResponse>, IValidatableObject
    {
        ...
        public CheckoutsResponse(bool hasMore = default(bool), string _object = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<CheckoutResponse> data = default(List<CheckoutResponse>))
        {
