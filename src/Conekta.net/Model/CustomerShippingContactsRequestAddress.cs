...
namespace Conekta.net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "customer_shipping_contacts_request_address")]
    public partial class CustomerShippingContactsRequestAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerShippingContactsRequestAddress" /> class.
        /// </summary>
        ...
        public CustomerShippingContactsRequestAddress(string street1 = default(string), string street2 = default(string), string postalCode = default(string), string city = default(string), string state = default(string), string country = default(string), bool residential = default(bool))
        {
