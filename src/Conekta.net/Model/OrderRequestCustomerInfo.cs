...
namespace Conekta.net.Model
{
    ...
    public partial class OrderRequestCustomerInfo : AbstractOpenAPISchema, IEquatable<OrderRequestCustomerInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderRequestCustomerInfo" /> class
        /// with the <see cref="CustomerInfo" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of CustomerInfo.</param>
        public OrderRequestCustomerInfo(CustomerInfo actualInstance)
        {
        ...
        public OrderRequestCustomerInfo(CustomerInfoJustCustomerId actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, OrderRequestCustomerInfo.SerializerSettings);
        }
        ...
        public static OrderRequestCustomerInfo FromJson(string jsonString)
        {
            OrderRequestCustomerInfo newOrderRequestCustomerInfo = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newOrderRequestCustomerInfo;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newOrderRequestCustomerInfo = new OrderRequestCustomerInfo(JsonConvert.DeserializeObject<CustomerInfo>(jsonString, OrderRequestCustomerInfo.SerializerSettings));
                }
                else
                {
                    newOrderRequestCustomerInfo = new OrderRequestCustomerInfo(JsonConvert.DeserializeObject<CustomerInfo>(jsonString, OrderRequestCustomerInfo.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newOrderRequestCustomerInfo = new OrderRequestCustomerInfo(JsonConvert.DeserializeObject<CustomerInfoJustCustomerId>(jsonString, OrderRequestCustomerInfo.SerializerSettings));
                }
                else
                {
                    newOrderRequestCustomerInfo = new OrderRequestCustomerInfo(JsonConvert.DeserializeObject<CustomerInfoJustCustomerId>(jsonString, OrderRequestCustomerInfo.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as OrderRequestCustomerInfo);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(OrderRequestCustomerInfo input)
        {
            if (input == null)
                return false;
    ...
    /// </summary>
    public class OrderRequestCustomerInfoJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(OrderRequestCustomerInfo).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return OrderRequestCustomerInfo.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
