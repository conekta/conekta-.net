...
namespace Conekta.net.Model
{
    ...
    public partial class OrderRequestCustomerInfo : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        public OrderRequestCustomerInfo(CustomerInfoCustomerId actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public static OrderRequestCustomerInfo FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                {
                    newOrderRequestCustomerInfo = new OrderRequestCustomerInfo(JsonConvert.DeserializeObject<CustomerInfoCustomerId>(jsonString, OrderRequestCustomerInfo.SerializerSettings));
                }
                else
                {
                    newOrderRequestCustomerInfo = new OrderRequestCustomerInfo(JsonConvert.DeserializeObject<CustomerInfoCustomerId>(jsonString, OrderRequestCustomerInfo.AdditionalPropertiesSerializerSettings));
                }
