...
namespace Conekta.net.Model
{
    ...
    /// an updated webhook
    /// </summary>
    [DataContract(Name = "update_webhook")]
    public partial class UpdateWebhook : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateWebhook" /> class.
        /// </summary>
        /// <param name="url">Here you must place the URL of your Webhook remember that you must program what you will do with the events received. Also do not forget to handle the HTTPS protocol for greater security..</param>
        /// <param name="subscribedEvents">events that will be sent to the webhook.</param>
        /// <param name="active">whether the webhook is active or not.</param>
        public UpdateWebhook(string url = default(string), List<string> subscribedEvents = default(List<string>), bool active = default(bool))
        {
            this.Url = url;
