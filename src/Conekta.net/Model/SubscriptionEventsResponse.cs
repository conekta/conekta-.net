...
namespace Conekta.net.Model
{
    ...
    public partial class SubscriptionEventsResponse : IEquatable<SubscriptionEventsResponse>, IValidatableObject
    {
        ...
        public SubscriptionEventsResponse(string _object = default(string), bool hasMore = default(bool), string nextPageUrl = default(string), string previousPageUrl = default(string), List<EventResponse> data = default(List<EventResponse>))
        {
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for SubscriptionEventsResponse and cannot be null");
            }
            this.Object = _object;
