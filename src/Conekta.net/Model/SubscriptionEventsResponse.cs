...
namespace Conekta.net.Model
{
    ...
    public partial class SubscriptionEventsResponse : IEquatable<SubscriptionEventsResponse>, IValidatableObject
    {
        ...
        public SubscriptionEventsResponse(bool hasMore = default(bool), string _object = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<EventResponse> data = default(List<EventResponse>))
        {
