...
namespace Conekta.net.Model
{
    ...
    public partial class SubscriptionEventsResponse : IEquatable<SubscriptionEventsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionEventsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubscriptionEventsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionEventsResponse" /> class.
        /// </summary>
        ...
        public SubscriptionEventsResponse(bool hasMore = default(bool), string varObject = default(string), string nextPageUrl = default(string), string previousPageUrl = default(string), List<EventResponse> data = default(List<EventResponse>))
        {
            this.HasMore = hasMore;
            // to ensure "varObject" is required (not null)
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for SubscriptionEventsResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as SubscriptionEventsResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionEventsResponse input)
        {
            if (input == null)
            {
                return false;
