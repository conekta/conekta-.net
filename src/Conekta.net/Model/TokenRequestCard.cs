...
namespace Conekta.net.Model
{
    ...
    /// TokenRequestCard
    /// </summary>
    [DataContract(Name = "token_request_card")]
    public partial class TokenRequestCard : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenRequestCard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TokenRequestCard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenRequestCard" /> class.
        /// </summary>
        ...
        public TokenRequestCard(string cvc = default(string), string deviceFingerprint = default(string), string expMonth = default(string), string expYear = default(string), string name = default(string), string number = default(string))
        {
            // to ensure "cvc" is required (not null)
            if (cvc == null)
            {
                throw new ArgumentNullException("cvc is a required property for TokenRequestCard and cannot be null");
            }
            this.Cvc = cvc;
            // to ensure "expMonth" is required (not null)
            if (expMonth == null)
            {
                throw new ArgumentNullException("expMonth is a required property for TokenRequestCard and cannot be null");
            }
            this.ExpMonth = expMonth;
            // to ensure "expYear" is required (not null)
            if (expYear == null)
            {
                throw new ArgumentNullException("expYear is a required property for TokenRequestCard and cannot be null");
            }
            this.ExpYear = expYear;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TokenRequestCard and cannot be null");
            }
            this.Name = name;
            // to ensure "number" is required (not null)
            if (number == null)
            {
                throw new ArgumentNullException("number is a required property for TokenRequestCard and cannot be null");
            }
            this.Number = number;
