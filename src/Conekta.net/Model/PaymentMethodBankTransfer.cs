...
namespace Conekta.net.Model
{
    ...
    public partial class PaymentMethodBankTransfer : IEquatable<PaymentMethodBankTransfer>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PaymentMethodBankTransfer);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(PaymentMethodBankTransfer input)
        {
            if (input == null)
            {
                return false;
