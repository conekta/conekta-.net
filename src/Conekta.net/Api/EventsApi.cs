...
namespace Conekta.net.Api
{
    ...
    public interface IEventsApiSync : IApiAccessor
    {
        ...
        ApiResponse<GetEventsResponse> GetEventsWithHttpInfo(string acceptLanguage = default(string), int? limit = default(int?), string search = default(string), string next = default(string), string previous = default(string), int operationIndex = 0);
    ...
    public partial class EventsApi : IEventsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>EventResponse</returns>
        public EventResponse GetEvent(string id, string acceptLanguage = default(string), int operationIndex = 0)
        {
            Conekta.net.Client.ApiResponse<EventResponse> localVarResponse = GetEventWithHttpInfo(id, acceptLanguage);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EventResponse</returns>
        public Conekta.net.Client.ApiResponse<EventResponse> GetEventWithHttpInfo(string id, string acceptLanguage = default(string), int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EventResponse</returns>
        public async System.Threading.Tasks.Task<EventResponse> GetEventAsync(string id, string acceptLanguage = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Conekta.net.Client.ApiResponse<EventResponse> localVarResponse = await GetEventWithHttpInfoAsync(id, acceptLanguage, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EventResponse)</returns>
        public async System.Threading.Tasks.Task<Conekta.net.Client.ApiResponse<EventResponse>> GetEventWithHttpInfoAsync(string id, string acceptLanguage = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetEventsResponse</returns>
        public GetEventsResponse GetEvents(string acceptLanguage = default(string), int? limit = default(int?), string search = default(string), string next = default(string), string previous = default(string), int operationIndex = 0)
        {
            Conekta.net.Client.ApiResponse<GetEventsResponse> localVarResponse = GetEventsWithHttpInfo(acceptLanguage, limit, search, next, previous);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetEventsResponse</returns>
        public Conekta.net.Client.ApiResponse<GetEventsResponse> GetEventsWithHttpInfo(string acceptLanguage = default(string), int? limit = default(int?), string search = default(string), string next = default(string), string previous = default(string), int operationIndex = 0)
        {
            Conekta.net.Client.RequestOptions localVarRequestOptions = new Conekta.net.Client.RequestOptions();
        ...
        {
            Conekta.net.Client.ApiResponse<GetEventsResponse> localVarResponse = await GetEventsWithHttpInfoAsync(acceptLanguage, limit, search, next, previous, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
