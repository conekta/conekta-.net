...
namespace Conekta.net.Test.Api
{
    ...
    public class PaymentLinkApiTests : IDisposable
    {
        ...
        public void CancelCheckoutTest()
        {
            ...
            //var response = instance.CancelCheckout(id, acceptLanguage);
        ...
        public void CreateCheckoutTest()
        {
            ...
            //string acceptLanguage = null;
            //var response = instance.CreateCheckout(checkout, acceptLanguage);
            //Assert.IsType<CheckoutResponse>(response);
        }
        ...
        public void EmailCheckoutTest()
        {
            ...
            //string acceptLanguage = null;
            //var response = instance.EmailCheckout(id, emailCheckoutRequest, acceptLanguage);
            //Assert.IsType<CheckoutResponse>(response);
        }
        ...
        public void GetCheckoutTest()
        {
            ...
            //string id = null;
            //string acceptLanguage = null;
            //var response = instance.GetCheckout(id, acceptLanguage);
            //Assert.IsType<CheckoutResponse>(response);
        }
        ...
        public void GetCheckoutsTest()
        {
            ...
            //var response = instance.GetCheckouts(acceptLanguage, limit, search, next, previous);
        ...
        public void SmsCheckoutTest()
        {
            ...
            //string acceptLanguage = null;
            //var response = instance.SmsCheckout(id, smsCheckoutRequest, acceptLanguage);
            //Assert.IsType<CheckoutResponse>(response);
        }
    }
}
