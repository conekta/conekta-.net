...
namespace Conekta.net.Test.Api
{
    ...
    public class OrdersApiTests
    {
        ...
        public void CreateOrderCashTest()
        {
            ...
            List<ChargeRequest> charges = new List<ChargeRequest>()
            {
                new ChargeRequest(
                    1555,
            ...
            OrderRequestCustomerInfo customerInfo = new OrderRequestCustomerInfo(new CustomerInfoJustCustomerId("cus_2tKcHxhTz7xU5SymF"));
        ...
        public void CreateOrderDefaultErrTest()
        {
            ...
            OrderRequestCustomerInfo customerInfo = new OrderRequestCustomerInfo(new CustomerInfoJustCustomerId("cus_2tKcHxhTz7xU5SymF2"));
            OrderRequest orderRequest = new OrderRequest(
                currency: "MXN",
                customerInfo: customerInfo,
                lineItems: products,
        ...
        public void CreateOrderMsiTest()
        {
            ...
            OrderRequestCustomerInfo customerInfo = new OrderRequestCustomerInfo(new CustomerInfoJustCustomerId("cus_msi_2o8jK3TDtejmz1sYd"));
            OrderRequest orderRequest = new OrderRequest(
                currency: "MXN",
                customerInfo: customerInfo,
                lineItems: products,
        ...
        public void CreateOrderSavedCardTest()
        {
            ...
            OrderRequestCustomerInfo customerInfo = new OrderRequestCustomerInfo(new CustomerInfoJustCustomerId("cus_save_card_2o8jK3TDtejmz1sYd"));
            OrderRequest orderRequest = new OrderRequest(
                currency: "MXN",
                customerInfo: customerInfo,
                lineItems: products,
