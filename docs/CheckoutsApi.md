# Conekta.net.Api.CheckoutsApi

All URIs are relative to *https://api.conekta.io*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**CancelCheckout**](CheckoutsApi.md#cancelcheckout) | **PUT** /checkouts/{id}/cancel | cancels a checkout |
| [**CreateCheckout**](CheckoutsApi.md#createcheckout) | **POST** /checkouts | creates a new checkout |
| [**EmailCheckout**](CheckoutsApi.md#emailcheckout) | **POST** /checkouts/{id}/email | sends an email |
| [**GetCheckout**](CheckoutsApi.md#getcheckout) | **GET** /checkouts/{id} | returns a checkout |
| [**GetCheckouts**](CheckoutsApi.md#getcheckouts) | **GET** /checkouts | returns a set of checkouts |
| [**SmsCheckout**](CheckoutsApi.md#smscheckout) | **POST** /checkouts/{id}/sms | sends an sms |
...
namespace Example
{
    public class CancelCheckoutExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new CheckoutsApi(config);
            ...
            {
                Debug.Print("Exception when calling CheckoutsApi.CancelCheckout: " + e.Message);
...
{
    Debug.Print("Exception when calling CheckoutsApi.CancelCheckoutWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class CreateCheckoutExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CheckoutsApi.CreateCheckout: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling CheckoutsApi.CreateCheckoutWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class EmailCheckoutExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CheckoutsApi.EmailCheckout: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling CheckoutsApi.EmailCheckoutWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetCheckoutExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CheckoutsApi.GetCheckout: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling CheckoutsApi.GetCheckoutWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetCheckoutsExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CheckoutsApi.GetCheckouts: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling CheckoutsApi.GetCheckoutsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class SmsCheckoutExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling CheckoutsApi.SmsCheckout: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling CheckoutsApi.SmsCheckoutWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
